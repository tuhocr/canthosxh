...
if(Sys.info()['sysname'] == "Windows"){
  ...
  SXH_YEAR_2025 <- readRDS("F:/VAULT12/R/DRCUONG_PASTEUR/PROJECT_CHUAN_V3/CLEAN_DATA_OUTPUT/SXH_YEAR_2025.rds")
  SXH_YEAR_2026 <- readRDS("F:/VAULT12/R/DRCUONG_PASTEUR/PROJECT_CHUAN_V3/CLEAN_DATA_OUTPUT/SXH_YEAR_2026.rds")
...
date_ori_max  <- range(df$NGAY_VV)[2]
...
sidebar_chuan <- shinydashboard:::dashboardSidebar(
  ...
  sidebarMenu(
    ...
    shinydashboard:::menuItem("SXH",
             tabName = "sb_stats",
             icon = icon("dashboard")),
             
    menuItem("Số liệu thô",
             tabName = "sb_stats",
             icon = icon("dashboard"),
             startExpanded = F,
             menuSubItem("SXH 2025", href = "https://tuhocr.github.io/canthosxh/SXH_2025"),
             menuSubItem("SXH 2026", href = "https://tuhocr.github.io/canthosxh/SXH_2026")
             ),
    
    shinydashboard:::menuItem("Bản đồ Cần Thơ",
             href = "https://tuhocr.github.io/canthosxh/MAP_CANTHO",
             icon = icon("map"))
            ...
            fluidRow(
              tabBox(
                ...
                tabPanel(title = "Thống kê",
                         ...
                         fluidRow(shinydashboard:::box(DT:::DTOutput(outputId = "kq1"),
                                                       width = NULL,
                                                       height = NULL)),
...
server <- function(input, output) {
  ...
  # output$p3 <- renderUI({
  #   tags$iframe(seamless="seamless", src= "https://tuhocr.github.io/canthosxh/OUTPUT_BAOCAO_SXH_YEAR_2025/plotly_map_ok.html", 
  #               width=650, 
  #               height=650)
  # })
